...
$lang = array_merge($lang, array(
	...
	'ALPHA_DOTS'			=> 'Букви, числа и точки',
	'ALPHA_ONLY'			=> 'Само букви и числа',
	'ALPHA_SPACERS'			=> 'Букви/Числа и празно пространство',
	'ALPHA_UNDERSCORE'		=> 'Букви/Числа и долни черти',
	'ALPHA_PUNCTUATION'		=> 'Букви/Числа със запетая, точки, долни черти и тирета',
	...
	'DISPLAY_ON_MEMBERLIST'			=> 'Показвай на списъка с потребители',
	'DISPLAY_ON_MEMBERLIST_EXPLAIN'	=> 'Ако тази опция е включена, полето ще се показва на потребитеслката таблица в списъка с потребители.',
	'DISPLAY_ON_PM'					=> 'Показвай на екрана с преглед на лични съобщения',
	'DISPLAY_ON_PM_EXPLAIN'			=> 'Ако тази опция е включена, полето ще се показва на мини-профила при преглеждане на лично съобщение.',
	...
	'FIELD_BOOL'				=> 'Да и Не',
	'FIELD_CONTACT_DESC'		=> 'Контакт описание',
	'FIELD_CONTACT_URL'			=> 'Контакт линк',
	'FIELD_DATE'				=> 'Дата',
	'FIELD_DESCRIPTION'			=> 'Описание на полето',
	'FIELD_DESCRIPTION_EXPLAIN'	=> 'Описание',
	'FIELD_DROPDOWN'			=> 'Падащо меню',
	...
	'FIELD_INT'					=> 'Число',
	'FIELD_IS_CONTACT'			=> 'Покажи полето като контакт поле',
	'FIELD_IS_CONTACT_EXPLAIN'	=> 'Контакт полетата се показват в контакт секцията на потребителският профил и се показват по различно на мини профили до мнения и лични съобщения. Може да използвате <samp>%s</samp> като променлива, която ще бъде заменена със стойност предоставена от потребителя.',
	...
	'LETTER_NUM_DOTS'			=> 'Букви, цифри и точки',
	'LETTER_NUM_ONLY'			=> 'Букви и цифри',
	'LETTER_NUM_PUNCTUATION'	=> 'Букви, цифри, запетая, точка, долна черта и тирета',
	'LETTER_NUM_SPACERS'		=> 'Букви, цифри и празно място',
	'LETTER_NUM_UNDERSCORE'		=> 'Букви, цифри и долни черти',
