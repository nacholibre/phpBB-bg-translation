...
$lang = array_merge($lang, array(
	...
	'AUTO_PRUNE_SHADOW_FREQ'	=> 'Честота на автоматично изчистване на теми в сянка',
	'AUTO_PRUNE_SHADOW_DAYS'	=> 'Възраст на автоматично изчистване на теми в сянка',
	'AUTO_PRUNE_SHADOW_DAYS_EXPLAIN'	=> 'Брой дни след, които темите в сянка се изтриват.',
	'AUTO_PRUNE_SHADOW_FREQ_EXPLAIN'	=> 'Време в дни междру изчистванията.',
	...
	'FORUM_NAME_EMOJI'					=> 'Името на форума е невалидно.<br>Съдържа следните непозволени знаци:<br>%s',
	...
	'FORUM_PRUNE_SHADOW'				=> 'Включи автоматичното чистене на темите в сянка',
	'FORUM_PRUNE_SHADOW_EXPLAIN'			=> 'Изчиства форума от теми в сянка, настройте честота/възраст параметри долу.',
