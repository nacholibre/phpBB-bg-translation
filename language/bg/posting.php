...
$lang = array_merge($lang, array(
	...
	'ATTACH_COMMENT_NO_EMOJIS'	=> 'Коментара към прикаченият файл съдържа непозволени знаци (Emoji).',
	...
	'BBCODE_O_HELP'				=> 'Подреден списък: [list=1][*]първа точка[/list] или [lisa][*]Точка А[/list]  (alt+o)',
	...
	'CHARS_POST_CONTAINS'		=> array(
		1	=> 'Вашето съобщение съдържа %1$d знак.',
		2	=> 'Вашето съобщение съдържа %1$d знака.',
	),
	'CHARS_SIG_CONTAINS'		=> array(
		1	=> 'Вашият подпис съдържа %1$d знак.',
		2	=> 'Вашият подпис съдържа %1$d знака.',
	),
	...
	'DELETE_PERMANENTLY'		=> 'Изтрий трайно',
	'DELETE_POST_CONFIRM'		=> 'Сигурен ли си че искаш да изтриеш това мнение?',
	'DELETE_POST_PERMANENTLY_CONFIRM'	=> 'Потвърждавате ли <strong>трайното</strong> изтриване на това мнение?',
	'DELETE_POST_PERMANENTLY'	=> array(
		1	=> 'Трайно изтрии мнението, за да не може да бъде възстановено',
		2	=> 'Трайно изтрии %1$d мненията, за да не могат да бъдат възстановени',
	),
	'DELETE_POSTS_CONFIRM'		=> 'Потвърждавате ли, че искате да изтриете мненията?',
	'DELETE_POSTS_PERMANENTLY_CONFIRM'	=> 'Потвърждавате ли, че искате <strong>трайно</strong> да изтриете мненията?',
	'DELETE_REASON'				=> 'Причина за изтриване',
	'DELETE_REASON_EXPLAIN'		=> 'Причината ще бъде видима за модераторите.',
	'DELETE_POST_WARN'			=> 'Веднъж изтрито, мнението не може да бъде възстановено.',
	'DELETE_TOPIC_CONFIRM'		=> 'Сигурен ли сте че искате да изтриете тази тема?',
	'DELETE_TOPIC_PERMANENTLY'	=> array(
		1	=> 'Трайно изтрии темата, за да не може да бъде възстановена',
		2	=> 'Трайно изтрии %1$d теми, за да не могат да бъдат възстановени',
	),
	'DELETE_TOPIC_PERMANENTLY_CONFIRM'	=> 'Сигурен ли сте, че искате <strong>трайно</strong> да изтриете тази тема?',
	'DELETE_TOPICS_CONFIRM'		=> 'Сигурен ли сте, че искате да изтриете темите?',
	'DELETE_TOPICS_PERMANENTLY_CONFIRM'	=> 'Сигурен ли сте, че искате да изтриете <strong>трайно</strong> тези теми?',
	...
	'LOGIN_EXPLAIN_SOFT_DELETE'	=> 'Вие трябва да влезете за да можете да изтривате мнения',
	...
	'MAX_FLASH_HEIGHT_EXCEEDED'	=> array(
		1	=> 'Флаш файла може да е до %d пиксел във височина.',
		2	=> 'Флаш файла може да е до %d пиксела във височина.',
	),
	'MAX_FLASH_WIDTH_EXCEEDED'	=> array(
		1	=> 'Флаш файла може да е до %d пиксел във ширина.',
		2	=> 'Флаш файла може да е до %d пиксела във ширина.',
	),
	'MAX_IMG_HEIGHT_EXCEEDED'	=> array(
		1	=> 'Снимките може да са до %1$d пиксел във височина.',
		2	=> 'Снимките може да са до %1$d пиксела във височина.',
	),
	'MAX_IMG_WIDTH_EXCEEDED'	=> array(
		1	=> 'Снимките може да са до %1$d пиксел във ширина.',
		2	=> 'Снимките може да са до %1$d пиксела във ширина.',
	),

	'MESSAGE_BODY_EXPLAIN'		=> array(
		0	=> '', // zero means no limit, so we don't view a message here.
		1	=> 'Въведете съобщението си тук, то не може да съдържа повече от <strong>%d</strong> знак.',
		2	=> 'Въведете съобщението си тук, то не може да съдържа повече от <strong>%d</strong> знака.',
	),
	...
	'NO_TEMP_DIR'				=> 'Временната папка (Temp Folder) не може да бъде открита или няма нужните права за писане в нея.',

	'PARTIAL_UPLOAD'			=> 'Файл-а беше качен частично',
	'PHP_UPLOAD_STOPPED'		=> 'Качването на файла беше прекратено от PHP разширение.',
	'PHP_SIZE_NA'				=> 'Големината на качените файлове е надхвърлила максимума.',
	'PHP_SIZE_OVERRUN'			=> 'Прикаченият файл е прекалено голям, максималният размер е %1$d %2$s.<br />Това е настройка на PHP-то в php.ini файла и може да бъде променяна само от там.',
	...
	'POLL_OPTIONS_EXPLAIN'		=> array(
		1	=> 'Сложете всяка възможност на нов ред. Можете да въведете <strong>%d</strong> възможност.',
		2	=> 'Сложете всяка възможност на нов ред. Можете да въведете до <strong>%d</strong> възможности.',
	),
    'POLL_OPTIONS_EDIT_EXPLAIN'   => 'Сложи всяка възможност на нов ред. Можете да въведете до <strong>%d</strong> възможности.',
	'POLL_OPTIONS_EDIT_EXPLAIN'		=> array(
		1	=> 'Сложете всяка възможност на нов ред. Можете да въведете <strong>%d</strong> възможност.  Ако изтриете или добавите възможност, всички предишни гласове ще се нулират',
		2	=> 'Сложете всяка възможност на нов ред. Можете да въведете до<strong>%d</strong> възможности.  Ако изтриете или добавите възможност, всички предишни гласове ще се нулират',
	),
	...
	'QUOTE_DEPTH_EXCEEDED'		=> array(
		1	=> 'Можете да сложите само %d цитат един в друг.',
		2	=> 'Можете да сложите само %d цитата един в друг.',
	),
	'QUOTE_NO_NESTING'			=> 'Вие не можете да сложите цитати един в друг.',

    'REMOTE_UPLOAD_TIMEOUT'     => 'Файла не може да бъде качен, защото операцията отне прекалено много време.',
	'SAVE'						=> 'Запази',
	'SAVE_DATE'					=> 'Запази на',
	...
	'TOO_FEW_CHARS_LIMIT'		=> array(
		1	=> 'Трябва да въведете поне %1$d знак.',
	...
	'TOO_MANY_CHARS_LIMIT'		=> array(
		1	=> 'Максималният брой позволени знаци е %1$d.',
		2	=> 'Максималният брой позволени знаци е %1$d.',
	),
	...
	'UNSUPPORTED_CHARACTERS_MESSAGE'	=> 'Вашето съобщение съдържа неподдържани знаци:<br />%s',
	'UNSUPPORTED_CHARACTERS_SUBJECT'	=> 'Вашето заглавие съдържа неподдържани знаци:<br />%s',
    ...
    'WRONG_FILESIZE'            => 'Файла е прекалено голям, максималният размер е %1$d %2$s.',
	'WRONG_SIZE'				=> 'Изображението трябва да е поне %1$s пиксела широко, %2$s пиксела високо и максимално %3$s пиксела широко и %4$s пиксела високо. Изпратеното изображение е %5$s пиксела широко и %6$s пиксела високо.',
));
