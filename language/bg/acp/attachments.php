...
$lang = array_merge($lang, array(
	...
	'ATTACH_POST_TYPE'					=> 'Тип на мнение',
	...
	'FILES_GONE'			=> 'Някои от избраните файлове за изтриване не съществуват. Може вече да са изтрити. Прикачените файлове, които съществуваха бяха изтрити.',
	'FILES_STATS_WRONG'		=> 'Вашата файлова статистика вероятно е неточна и трябва да се синхронизира. Реалният брой на прикачените файлове = %1$d, общ размер на прикачените файлове = %2$s.<br />Натиснете %3$sтук%4$s за да ги синхронизирате.',
	...
	'NO_ATTACHMENTS'			=> 'Няма прикачени файлове намерени за този период.',
	'NO_EXT_GROUP'				=> 'Няма',
	...
	'RESYNC_FILES_STATS_CONFIRM'	=> 'Сигурни ли сте, че искате да синхронизирате файловата статистика?',
