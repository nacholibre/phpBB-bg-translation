...
$lang = array_merge($lang, array(
	...
	'ACP_HELP_PHPBB'			=> 'Поддръжка phpBB',
	...
	'CANNOT_CHANGE_FILE_GROUP'	=> 'Не може да се промени файлова група',
	'CANNOT_CHANGE_FILE_PERMISSIONS'	=> 'Не може да се променят правата на файла',
	'CANNOT_COPY_FILES'		=> 'Не мое да се копират файловете',
	'CANNOT_CREATE_SYMLINK'	=> 'Не може да се създаде symlink',
	'CANNOT_DELETE_FILES'	=> 'Не може да се изтрият файлове от системата',
	'CANNOT_DUMP_FILE'		=> 'Не може да се изсипе файла',
	'CANNOT_MIRROR_DIRECTORY'	=> 'Не може да се клонира директория',
	'CANNOT_RENAME_FILE'	=> 'Не може да се преименува файл от системата',
	'CANNOT_TOUCH_FILES'	=> 'Не може да се определи дали файла съществува',

	'CONTAINER_EXCEPTION' => 'Възникна грешка при създаването на контейнера заради инсталирано разширение. Поради тази причина всички разширения са изключени. Моля опитайте да изчистите кеша на форума. Всички разширения автоматично ще се включат, след като контейнер грешката се разреши. Ако тази грешка продтлжава, моля посетете <a href="https://www.phpbb.com/support">phpBB.com</a> за поддръжка.',
	...
	'NO_FILES_TO_DELETE'	=> 'Избраните файлове не съществуват.',
	...
	'RELEASE_ANNOUNCEMENT'		=> 'Известие',
	'REMIND'							=> 'Напомни',
	'REPARSE_LOCK_ERROR'				=> 'Парсирането вече е в процес.',
	'RESYNC'							=> 'Ресинхронизирай',

	'RUNNING_TASK'			=> 'Течаща задача: %s.',
	...
	'TASKS_NOT_READY'			=> 'Чакащи задачи:',
	'TASKS_READY'			=> 'Готови задачи:',
	'TOTAL_SIZE'			=> 'Общ размер',

	'UCP'					=> 'Потребителски панел',
	'URL_INVALID'			=> 'Предоставеният URL адрес за настройката “%1$s” е невалиден.',
	'USERNAMES_EXPLAIN'		=> 'Всяко име на различен ред',
	'USER_CONTROL_PANEL'	=> 'Потребителски контролен панел',

	'UPDATE_NEEDED'			=> 'Форума не е актуален.',
	'UPDATE_NOT_NEEDED'		=> 'Форума е актуален.',
	'UPDATES_AVAILABLE'		=> 'Има обновления:',
...
// Enviroment configuration checks, mbstring related
   ...
   'ERROR_MBSTRING_ENCODING_TRANSLATION'         => 'Кодировката за прозрачните знаци е неправилно настроена.',
   'ERROR_MBSTRING_ENCODING_TRANSLATION_EXPLAIN'   => '<var>mbstring.encoding_translation</var> трябва да е 0. За да видите как е зададена в момента, посетете <samp>PHP information</samp> страницата.',
   'ERROR_MBSTRING_HTTP_INPUT'                  => 'HTTP input character conversion е неправилно настроена.',
   'ERROR_MBSTRING_HTTP_INPUT_EXPLAIN'            => '<var>mbstring.http_input</var> трябва да е <samp>pass</samp>. За да видите как е зададена в момента, посетете <samp>PHP information</samp> страницата.',
   'ERROR_MBSTRING_HTTP_OUTPUT'               => 'HTTP output character conversion е неправилно настроена.',
   'ERROR_MBSTRING_HTTP_OUTPUT_EXPLAIN'         => '<var>mbstring.http_output</var> трябва да е <samp>pass</samp>. За да видите как е зададена в момента, посетете <samp>PHP information</samp> страницата.',
	...
	'NO_SEARCH_INDEX'	=> 'Няма индекс за търсене.<br />Моля, създайте индекс за “%1$s в %2$sиндекса за търсене%3$s.',
	...
	'PHP_VERSION_OLD'	=> 'PHP версията на този сървър (%1$s) няма да се поддържа от по-новите версии на phpBB. Минималната версия на PHP-то ще бъде %2$s. %3$sВиж повече информация%4$s',
	...
	'PURGE_CACHE_SUCCESS'	=> 'Кеша е успешно изчистен.',
	...
	'RESET_ONLINE_SUCCESS'				=> 'Изчистване на "Най-много потребители онлайн" статистиката - успешно',
	...
	'RESYNC_POSTCOUNTS_SUCCESS'			=> 'Ресинхронизиран брой на мненията',
	...
	'RESYNC_POST_MARKING_SUCCESS'	=> 'Ресинхронизирани теми (с точки)',
	...
	'RESYNC_STATS_SUCCESS'			=> 'Статистика',
	'RUN'							=> 'Давай',

	'STATISTIC'			=> 'Статистика',
    'STATISTIC_RESYNC_OPTIONS'	=> 'Ресинхронизирай или нулирай статистиката',
	'TIMEZONE_INVALID'	=> 'Избраната времева зона е невалидна.',
	'TIMEZONE_SELECTED'	=> '(избрана)',
	...
	'VERSION_CHECK'					=> 'Проверка на версия',
	'VERSION_CHECK_EXPLAIN'			=> 'Проверява дали phpBB инсталацията е най-новата версия.',
	'VERSIONCHECK_INVALID_ENTRY'	=> 'Последната версия съдържа неподдържани данни.',
	'VERSIONCHECK_INVALID_URL'		=> 'Последната версия съдържа невалиден URL адрес.',
	'VERSIONCHECK_INVALID_VERSION'	=> 'Последната версия съдържа невалидна версия.',
	'VERSION_NOT_UP_TO_DATE_ACP'	=> 'Вашата phpBB инсталация не е актуална.<br />Долу е линка с информацията за обновлението.',
	'VERSION_NOT_UP_TO_DATE_TITLE'	=> 'Вашата phpBB инсталация не е актуална.',
	'VERSION_UP_TO_DATE_ACP'		=> 'Вашата phpBB инсталация е актуална. Няма допълнителни обновления за момента.',
	'VIEW_ADMIN_LOG'		=> 'Виж целия лог',
	'VIEW_INACTIVE_USERS'	=> 'Виж неактивните потребители',

	'WELCOME_PHPBB'			=> 'Добре дошли в phpBB',
	'WRITABLE_CONFIG'		=> 'Вашият файл (config.php) е с права за писане. Променете ги на 640 или поне на 644 (пример: <a href="http://en.wikipedia.org/wiki/Chmod" rel="external">chmod</a> 640 config.php).',
));
...
$lang = array_merge($lang, array(
	...
	'FAIL_SEND_STATISTICS'		=> 'phpBB не успя да изпрати статистика',
));
...
$lang = array_merge($lang, array(
	...
	'LOG_BBCODE_CONFIGURATION_ERROR'	=> '<strong>Грешка при конфигуриране на BBCode</strong>: %1$s<br />» %2$s',
	...
	'LOG_DELETE_POST'			=> '<strong>Изтри мнение “%1$s” написано от “%2$s” поради следната причина</strong><br />» %3$s',
	'LOG_DELETE_SHADOW_TOPIC'	=> '<strong>Изтри темата</strong><br />» %s',
	'LOG_DELETE_TOPIC'			=> '<strong>Изтри тема “%1$s” написана от “%2$s” поради следната причина</strong><br />» %3$s',
	...
	'LOG_MOVED_TOPIC'			=> '<strong>Премести тема</strong><br />» %s',
	...
	'LOG_POST_DISAPPROVED'		=> '<strong>Отхвърли мнение “%1$s” написано от “%3$s” поради следната причина</strong><br />» %2$s',
	'LOG_POST_EDITED'			=> '<strong>Промени мнение “%1$s” написано от “%2$s” поради следната причина</strong><br />» %3$s',
	...
	'LOG_TOPIC_DISAPPROVED'		=> '<strong>Отхвърлена тема “%1$s” написана от "%3$s" поради следната причина</strong> <br />» %2$s',
	...
	'LOG_ERROR_CAPTCHA'		=> '<strong>CAPTCHA грешка</strong><br />» %s',
	...
	'LOG_PRUNE_SHADOW'		=> '<strong>Автоматично изчистени теми в сянка</strong><br />» %s',
	...
	'LOG_RESYNC_FILES_STATS'	=> '<strong>Файловата статистика е синхронизирана</strong>',
	...
	'LOG_WARNINGS_DELETED'		=> array(
		1 => '<strong>Изтри потребителско предупреждение</strong><br />» %1$s',
	...
	'LOG_EXT_ENABLE'	=> '<strong>Разширението включено</strong><br />» %s',
	'LOG_EXT_DISABLE'	=> '<strong>Разширението изключено</strong><br />» %s',
	'LOG_EXT_PURGE'		=> '<strong>Данните на разширението изтрити</strong><br />» %s',
	'LOG_EXT_UPDATE'	=> '<strong>Разширението обновено</strong><br />» %s',
));
