...
$lang = array_merge($lang, array(
	...
	'BOARD_INDEX_TEXT'				=> 'Текст на начална страница',
	'BOARD_INDEX_TEXT_EXPLAIN'		=> 'Този текст ще се показва на началната страница в навигацията (трохите). Ако полето е празно ще се използва “Форум начало”.',
	...
	'DEFAULT_STYLE_EXPLAIN'			=> 'Стила по подразбиране за нови потребители.',
	...
	'DISPLAY_LAST_SUBJECT'			=> 'Показвай заглавието на последното добавено мнение форум списъка',
	'DISPLAY_LAST_SUBJECT_EXPLAIN'	=> 'Заглавието на последното мнение ще бъде добавено с линк към самото мнение в списъка на форума.',
	'GUEST_STYLE'					=> 'Гост стил',
	...
	'SITE_HOME_TEXT'				=> 'Главен уебсайт текст',
	'SITE_HOME_TEXT_EXPLAIN'		=> 'Този текст ще се показва на линка към главната страница на форума в навигацията (трохите). Ако полето е празно, ще се използва "Начало".',
	'SITE_HOME_URL'					=> 'Главен уебсайт URL',
	'SITE_HOME_URL_EXPLAIN'			=> 'Ако се добави, този линк ще се използва като начална страница вместо линка към форума ви. Линка трябва да е абсолютен <samp>http://www.phpbb.com</samp>.',
	...
	'WARNINGS_EXPIRE_EXPLAIN'		=> 'Време в дни, през което ще бъде активно предупреждението. Задайте 0 за безкрайно.',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_BOARD_NOTIFICATIONS' => 'Включи известията във форума',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_GRAVATAR'				=> 'Включи Граватар аватари',
...
$lang = array_merge($lang, array(
	...
	'ALLOWED_SCHEMES_LINKS'				=> 'Позволявай схеми в линкове',
	'ALLOWED_SCHEMES_LINKS_EXPLAIN'		=> 'Потребителите могат да пускат само URLs без схеми или лист от схеми разделени със запетая.',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_WARNING'		=> 'Моля имайте предвид, че избраният метод за активация изисква имейлите да бъдат включени, иначе регистрацията няма да е възможна. Препоръчваме ви да изберете друг метод за активация или да активирате имейлите.',
...
$lang = array_merge($lang, array(
	...
	'ACP_VC_EXT_GET_MORE'					=> 'За допълнителни анти спам добавки, посетете <a href="https://www.phpbb.com/go/anti-spam-ext"><strong>phpBB.com база данни с добавки</strong></a>. За повече информация как може да се справите със спама посетете <a href="https://www.phpbb.com/go/anti-spam"><strong>phpBB.com инфо</strong></a>.',
...
$lang = array_merge($lang, array(
	...
	'COOKIE_DOMAIN_EXPLAIN'		=> 'В повечето случаи домейна не е задължителен. Оставете полето празно, ако не сте сигурни.',
	'COOKIE_NAME'				=> 'Име на бисквитките',
	'COOKIE_NAME_EXPLAIN'		=> 'Тук може да въведете каквото ви хрумне.',
	'COOKIE_NAME'				=> 'Бисквитка име',
	'COOKIE_PATH'				=> 'Бисквитка път',
	'COOKIE_PATH_EXPLAIN'		=> 'Тук обикновенно е същият път като пътя до скрипта ви или просто /.',
	'COOKIE_NOTICE'				=> 'Cookie известие',
	'COOKIE_NOTICE_EXPLAIN'		=> 'Ако тази опция е включена, на всеки потребител ще се появява известие, че сайта използва бисквитки. В някой държави това се изисква от закона.',
...
// Contact Settings
$lang = array_merge($lang, array(
	'ACP_CONTACT_SETTINGS_EXPLAIN'		=> 'От тука можете да включите/изключите страницата за обратна връзка, както и да добави текст, които да се появява на нея.',

	'CONTACT_US_ENABLE'				=> 'Включи страницата за обратна връзка',
	'CONTACT_US_ENABLE_EXPLAIN'		=> 'Тази страница позволява на потребителите да изпращат имейли до администраторите на форума. Имайте предивд, че глобалната функция за имейли също трябва да е включена..',

	'CONTACT_US_INFO'				=> 'Информация',
	'CONTACT_US_INFO_EXPLAIN'		=> 'Съобщението се показва на страницата за обратна връзка',
	'CONTACT_US_INFO_PREVIEW'		=> 'Информация - Преглед',
	'CONTACT_US_INFO_UPDATED'		=> 'Информацията е обновена.',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_CDN'						=> 'Позволи използването на third party CDN',
	'ALLOW_CDN_EXPLAIN'				=> 'Ако тази опция е пусната, някои от файловете ще се сервират от външни сървъри. Това ще намали трафика към вашият сървър. При нормална инсталация, това включва “jQuery” и шрифта “Open Sans” от сървърите на Гугъл.',
	'ALLOW_LIVE_SEARCHES'			=> 'Позволи автоматично попълване на полета',
	'ALLOW_LIVE_SEARCHES_EXPLAIN'	=> 'Ако тази опция е пусната, потребителите ще получават предложения още докато пишат текст в различните полета.',
	...
	'LOAD_CPF_PM'					=> 'Показвай персонализираните полета в личните съобщения',
	...
	'LOAD_USER_ACTIVITY_LIMIT'		=> 'Показвай списъка с активност на потребителя',
	'LOAD_USER_ACTIVITY_LIMIT_EXPLAIN'	=> 'Активната тема/форум няма да бъде показвана за потребители, които имат повече от този брой мнения. Сложете 0 за да изключите тази функция.',
	'READ_NOTIFICATION_EXPIRE_DAYS'	=> 'Прочетено известия изтичане',
	'READ_NOTIFICATION_EXPIRE_DAYS_EXPLAIN' => 'Брой дни, след които прочетено известие ще бъде автоматично изтрито. Сложете 0 за да направите известията перманентни.',
	...
	'YES_ACCURATE_PM_BUTTON'			=> 'Включи правно специфичен ЛС бутон в страниците на теми',
	'YES_ACCURATE_PM_BUTTON_EXPLAIN'	=> 'Ако тази опция е включена, само профили на потребители, които могат да четат лични съобщения ще имат бутона за лични съобщения.',
...
$lang = array_merge($lang, array(
	...
	'AUTH_PROVIDER_OAUTH_ERROR_ELEMENT_MISSING'	=> 'Ключа и тайната трябва да се въведат за всеки OAuth провайдър. Само един беше въведен.',
	'AUTH_PROVIDER_OAUTH_EXPLAIN'				=> 'Всеки OAuth провайдър изисква уникален таен ключ и ключ за да се удостоверява с външен сървър. Тези ключове трябва да ви се предоставят от OAuth провайдъра при регистрация.',
	'AUTH_PROVIDER_OAUTH_KEY'					=> 'Ключ',
	'AUTH_PROVIDER_OAUTH_TITLE'					=> 'OAuth',
	'AUTH_PROVIDER_OAUTH_SECRET'				=> 'Тайна',
...
$lang = array_merge($lang, array(
	...
	'MOD_REWRITE_ENABLE'		=> 'Включи URL пренаписване',
	'MOD_REWRITE_ENABLE_EXPLAIN' => 'Когато се включи, адреси съдържащи ’app.php’ ще бъдат пренаписани и няма да съдържат името на файла (пример app.php/foo ще стане само /foo). <strong>Apache mod_rewrite модула трябва да е включен за да работи тази функция; ако тази опция се пусне без да се включи mod_rewrite може да възникнат проблеми с адресите във форума.</strong>',
	'MOD_REWRITE_DISABLED'		=> '<strong>mod_rewrite</strong> Apache модула е изключен. Включете модула или се свържете с администратора на сървъра за да го включи.',
	'MOD_REWRITE_INFORMATION_UNAVAILABLE' => 'Не може да установим дали този сървър поддържа пренаписване на адресите. Ако не знаете дали тази опция се поддържа, не я пускайте.',
	...
	'USE_SYSTEM_CRON'		=> 'Пускай периодични задачи от системният cron',
	'USE_SYSTEM_CRON_EXPLAIN'		=> 'Когато е изключено phpBB ще зарежда периодичните задачи автоматично. Когато е включено, phpBB няма да нарежда задачи автоматично; системен администратор трябва да зареди <code>bin/phpbbcli.php cron:run</code> да се пуска на чести инвервали (например на всеки 5 минути).',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_PASSWORD_RESET'			=> 'Позволи да се променя паролата ("Забравена парола")',
	'ALLOW_PASSWORD_RESET_EXPLAIN'	=> 'Разрешава или забранява използването на функцията "Забравена парола". Ако използвате външна услуга за удостоверяване е хубаво да изключите тази функция.',
	...
	'CHECK_DNSBL_EXPLAIN'			=> 'Ако е включена потребителските IP адреси се проверяват според DNXBL: <a href="http://spamcop.net">spamcop.net</a> и <a href="http://www.spamhaus.org">www.spamhaus.org</a>. В зависимост от сървъра може да отнеме доста време.',
	'CLASS_B'						=> 'A.B',
	'CLASS_C'						=> 'A.B.C',
	...
	'REFERRER_VALID'				=> 'Валидирай Referrer',
	'REFERRER_VALID_EXPLAIN'		=> 'Ако опцията е включена, всички POST заявки ще бъдат проверявани за host/script пътя. Това може да създаде проблеми, ако форума се използва от няколко домейна едновременно.',
	...
	'UPLOAD_CERT_VALID'				=> 'Валидирай каченият сертификат',
	'UPLOAD_CERT_VALID_EXPLAIN'		=> 'Ако е включено, сертификатите на отдалечените качвания ще се валидират. Това изисква CA bundle да бъде дефиниран от <samp>openssl.cafile</samp> или <samp>curl.cainfo</samp> настройката в php.ini.',
));
...
$lang = array_merge($lang, array(
	...
	'CONTACT_EMAIL_NAME_EXPLAIN'	=> 'Това е името, което имейл получателите ще виждат. Ако не искате да имате контакт име, оставете това поле празно.',
	'EMAIL_FORCE_SENDER'			=> 'Форсирай от имейл адрес',
	'EMAIL_FORCE_SENDER_EXPLAIN'	=> 'Това ще настрои изпращача на имейла. Тази настройка не важи когато се използва SMTP.<br><em><strong>Внимание:</strong> Изисква потребителя, на който върви уеб сайта да се добави в доверените потребителите на sendmail конфигурацията.</em>',
	'EMAIL_PACKAGE_SIZE'			=> 'Размер на email пакети',
	'EMAIL_PACKAGE_SIZE_EXPLAIN'	=> 'Броя съобщения изпратени в един пакет.',
	'EMAIL_MAX_CHUNK_SIZE'			=> 'Максималният позволен брой на получатели',
	'EMAIL_MAX_CHUNK_SIZE_EXPLAIN'	=> 'При нужда от тук можете да настроите максималният позволен брой на получатели.',
	...
	'SEND_TEST_EMAIL'				=> 'Изпрати тестов мейл',
	'SEND_TEST_EMAIL_EXPLAIN'		=> 'Изпраща тестов мейл до адреса дефиниран във вашият акаунт.',
	'SMTP_ALLOW_SELF_SIGNED'		=> 'Позволи самоподписани SSL сертификати',
	'SMTP_ALLOW_SELF_SIGNED_EXPLAIN'=> 'Позволи свързване към STMP сървъри със самоподписани сертификати. <br><em><strong>Внимание:</strong> Това може да създаде проблеми със сигурността.</em>',
	'SMTP_AUTH_METHOD'				=> 'Метод за удостоверяване на SMTP',
	'SMTP_AUTH_METHOD_EXPLAIN'		=> 'Използва се само ако са настроени потребителско име и парола.',
	...
	'SMTP_VERIFY_PEER'				=> 'Верифицирай SSL сертификат',
	'SMTP_VERIFY_PEER_EXPLAIN'		=> 'Изисква верификация на SSL сертификата на SMTP сървъра. <br><em><strong>Внимание:</strong> Свързване към сървъри с неверифицирани сертификати може да доведе до проблеми със сигурността.</em>',
	'SMTP_VERIFY_PEER_NAME'			=> 'Верифицирай SMTP peer name',
	'SMTP_VERIFY_PEER_NAME_EXPLAIN'	=> 'Изисква верификация на SSL/TLS сертификата на SMTP сървъра. <br><em><strong>Внимание:</strong> Свързване към сървъри с неверифицирани сертификати може да доведе до проблеми със сигурността.</em>',
	'TEST_EMAIL_SENT'				=> 'Беше изпратен тестов мейл.<br>Ако не го получавате, моля проверете настройките на имейла.<br><br>Ако имате нужда от помощ, моля посетете <a href="https://www.phpbb.com/community/">phpBB форумите за поддръжка</a>.',
	'SMTP_SERVER'					=> 'SMTP сървър адрес',
	'SMTP_SERVER_EXPLAIN'			=> 'Не въвеждайте протокол (<samp>ssl://</samp> или <samp>tsl://</samp>) освен ако не е нужно.',
...
$lang = array_merge($lang, array(
	...
	'JAB_ALLOW_SELF_SIGNED'			=> 'Позволи авто подписани SSL сертификати',
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> 'Позволява връзка със Jabber сървъри със самоподписани SSL сертификати. <br><em><strong>Внимание:</strong> Това може да довете до проблеми в сигурността.</em>',
	...
	'JAB_VERIFY_PEER'				=> 'Верифицирай SSL сертификат',
	'JAB_VERIFY_PEER_EXPLAIN'		=> 'Изисква верификация на SSL сетификата използван от Jabber сървъра. <br><em><strong>Внимание:</strong> Свързване към неверифицирани SSL сертификати може да създаде проблеми със сигурността.</em>',
	'JAB_VERIFY_PEER_NAME'			=> 'Верифицирай Jabber име',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'Изисква верификация на SSL/TLS сетификата използван от Jabber сървъра. <br><em><strong>Внимание:</strong> Свързване към неверифицирани SSL сертификати може да създаде проблеми със сигурността.</em>',
));
