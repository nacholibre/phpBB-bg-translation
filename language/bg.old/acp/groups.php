...
$lang = array_merge($lang, array(
	...
	'GROUP_CATEGORY_NAME'			=> 'Име на категория',
	...
	'GROUP_CONFIRM_ADD_USERS'		=> array(
		1	=> 'Сигурни ли сте, че искате да добавите потребителя %2$s в групата?',
		2	=> 'Сигурни ли сте, че искате да добавите потребителите %2$s в групата?',
	),
	...
	'GROUP_SPECIAL'					=> 'Пре-дефиниран',
	'GROUP_TEAMPAGE'				=> 'Показвай група на екипната страница',
	...
	'GROUP_USERS_INVALID'			=> 'Потребителското име не съществува: %s',

	'LEGEND_EXPLAIN'				=> 'Това с групите, които се показват в легендата на друпата:',
	'LEGEND_SETTINGS'				=> 'Легенда настройки',
	'LEGEND_SORT_GROUPNAME'			=> 'Сортирай легендата по име на групата',
	'LEGEND_SORT_GROUPNAME_EXPLAIN'	=> 'Реда се игнорира когато тази опция е включена.',

	'MANAGE_LEGEND'			=> 'Управление на легендата на групата',
	'MANAGE_TEAMPAGE'		=> 'Управление на екипната страница',

	'MAKE_DEFAULT_FOR_ALL'	=> 'Направи групата по подразбиране за всеки потребител',
	'MEMBERS'				=> 'Потребители',

	'NO_GROUP'					=> 'Няма избрана група.',
	'NO_GROUPS_ADDED'			=> 'Няма добавни групи.',
	...
	'TEAMPAGE'					=> 'Екипна страница',
	'TEAMPAGE_DISP_ALL'			=> 'Всички членове',
	'TEAMPAGE_DISP_DEFAULT'		=> 'Само групата по подразбиране на потребителя',
	'TEAMPAGE_DISP_FIRST'		=> 'Само първо членство',
	'TEAMPAGE_EXPLAIN'			=> 'Тези са групите, които ще се показват на екипната страница:',
	'TEAMPAGE_FORUMS'			=> 'Показвай модерираните форуми',
	'TEAMPAGE_FORUMS_EXPLAIN'	=> 'Ако тази опция се включи, модераторите ще имат списък с всички форуми в които имат модераторски права. За големи форуми може да е бавно.',
	'TEAMPAGE_MEMBERSHIPS'		=> 'Показвай потребителските членувания',
	'TEAMPAGE_SETTINGS'			=> 'Екипна страница настройки',
