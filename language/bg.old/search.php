...
$lang = array_merge($lang, array(
	...
	'MAX_NUM_SEARCH_KEYWORDS_REFINE'	=> array(
		1	=> 'Избрали сте прекалено много дуим за търсене. Моля не въвеждайте повече от %1$d дума.',
		2	=> 'Избрали сте прекалено много дуим за търсене. Моля не въвеждайте повече от %1$d думи.',
	),

    'NO_KEYWORDS'            => 'Вие трябва да въведете поне една дума за търсене. Всяка дума трябва да съдържа най-малко %s букви и не трябва да надхвърля %s думи.',
	...
	'NO_SEARCH_LOAD'		=> 'В момента функцията търсене не може да се използва, сайта е под голямо натоварване. Моля опитайте по-късно.',
	'NO_SEARCH_TIME'		=> array(
		1	=> 'Вие не може да търсите в момента. Моля опитайте след %d секунда.',
		2	=> 'Вие не може да търсите в момента. Моля опитайте след %d секунди.',
	),
	...
	'SPHINX_SEARCH_FAILED_LOG'	=> 'Търсенето не може да се изпълни. Повече информация ще намерите в лога за грешки.',

	'TOO_FEW_AUTHOR_CHARS'	=> array(
		1	=> 'Трябва да въведете поне %d знак за име на автор.',
		2	=> 'Трябва да въведете поне %d знака за име на автор.',
	),
));
