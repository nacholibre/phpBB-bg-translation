...
$lang = array_merge($lang, array(
    ...
    'INSTALL_INTRO_BODY'		=> 'С тази функция можете да инсталирате форума.
    ...
    <p>Само поддържаните бази данни от вашият сървър ще бъдат показвани.</p>',
	...
	'SUPPORT_BODY'				=> 'Пълна безплатна поддръжка ще бъде осигурена за phpBB3. Това включва:<ul><li>инсталация</li><li>конфигурация</li><li>технически въпроси</li><li>проблеми свързани с потенциален бъг в софтуера ни</li><li>обновяване</li><li>конвертиране от phpBB2 до phpBB3</li><li>конвертиране от други системи (моля прочетете <a href="https://www.phpbb.com/community/viewforum.php?f=486">форум конвертиране</a>)</li></ul><p>Знаем, че все още има потребители използващи BETA версии на нашия софтуер и затова ги стимулираме да преминат към финалната STABLE версия.</p><h2>Модификации / Стилове</h2><p>За проблеми свързани с различните модификации, моля пишете във <a href="https://www.phpbb.com/community/viewforum.php?f=451">форум разширения и стилове</a>.</p><br /><br />При други въпроси, моля посетете<a href="https://www.phpbb.com/support/">секцията за поддръжка</a><br /><br />',
