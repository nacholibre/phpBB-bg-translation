...
$lang = array_merge($lang, array(
	...
	'ATTACHMENT_LOCKED'				=> 'Тази тема е заключена, не можете да изтриете прикачен файл.',
	'AUTOLOGIN_SESSION_KEYS_DELETED'=> 'Избраните ключове бяха успешно изтрити.',
	'AVATAR_CATEGORY'				=> 'Категория',
	'AVATAR_DRIVER_GRAVATAR_TITLE'	=> 'Граватар',
	'AVATAR_DRIVER_GRAVATAR_EXPLAIN'=> 'Граватар е услуга, която позволява да поддържате един и същи аватар на различни сайтове. Посетете <a href="http://www.gravatar.com/">Gravatar</a> for more information.',
	'AVATAR_DRIVER_LOCAL_TITLE'		=> 'Галерия',
	'AVATAR_DRIVER_LOCAL_EXPLAIN'	=> 'Вие можете да изберете вашият аватар от локалният набор',
	'AVATAR_DRIVER_REMOTE_TITLE'	=> 'Отдалечен аватар',
	'AVATAR_DRIVER_REMOTE_EXPLAIN'	=> 'Линк към аватара от друг уебсайт.',
	'AVATAR_DRIVER_UPLOAD_TITLE'	=> 'Качете аватар',
	'AVATAR_DRIVER_UPLOAD_EXPLAIN'	=> 'Качете ваш собствен аватар.',
	'AVATAR_EXPLAIN'				=> 'Максимални размери; ширина: %1$s, височина: %2$s, размер на файл: %3$.2f KiB.',
	...
	'AVATAR_SELECT'					=> 'Изберете своят аватар',
	...
	'BOARD_DATE_FORMAT_EXPLAIN'	=> 'Използваният синтаксис е идентичен с PHP <a href="https://secure.php.net/manual/function.date.php">date()</a> функцията.',
	'BOARD_LANGUAGE'			=> 'Език',
	'BOARD_STYLE'				=> 'Стил',
	...
	'FIELD_TOO_SHORT'					=> array(
		1	=> 'Полето “%2$s” е прекалено късо, минималният брой позволени знаци е %1$d.',
		2	=> 'Полето “%2$s” е прекалено късо, минималният брой позволени знаци е %1$d.',
	),
	'FIELD_TOO_LONG'					=> array(
		1	=> 'Полето “%2$s” е прекалено дълго, максималният брой позволени знаци е %1$d.',
		2	=> 'Полето “%2$s” е прекалено дълго, максималният брой позволени знаци е %1$d.',
	),
	...
	'FIELD_INVALID_CHARS_INVALID'		=> 'Полето “%s” съдържа невалидни знаци.',
	'FIELD_INVALID_CHARS_NUMBERS_ONLY'	=> 'Полето “%s” съдържа непозволени знаци, само числата са разрешени.',
	'FIELD_INVALID_CHARS_ALPHA_DOTS'	=> 'Полето “%s” съдържа невалидни знаци, само букви/цифри или . знаци са позволени.',
	'FIELD_INVALID_CHARS_ALPHA_ONLY'	=> 'Полето “%s” съдържа непозволени знаци, само латинските знаци са позволени.',
	'FIELD_INVALID_CHARS_ALPHA_PUNCTUATION'	=> 'Полето “%s” съдържа невалидни знаци, само букви/цифри и _,-. са позволени, а първият знак трябва да е задължително буква или цифра.',
	'FIELD_INVALID_CHARS_ALPHA_SPACERS'	=> 'Полето “%s” съдържа невалидни знаци, само букви/цифри, празно място или -+_[] са позволени.',
	'FIELD_INVALID_CHARS_ALPHA_UNDERSCORE'	=> 'Полето “%s” съдържа невалидни знаци, само букви/цифри или _ са позволени.',
	'FIELD_INVALID_CHARS_LETTER_NUM_DOTS'	=> 'Полето “%s” съдържа невалидни знаци, само букви, цифри или . са позволени.',
	'FIELD_INVALID_CHARS_LETTER_NUM_ONLY'	=> 'Полето “%s” съдържа невалидни знаци, позволени са само букви и цифри.',
	'FIELD_INVALID_CHARS_LETTER_NUM_PUNCTUATION'	=> 'Полето “%s” съдържа невалидни знаци, само букви, цифри или _,-. знаци са позволени, а първият знак трябва да е задължително буква или цифра.',
	'FIELD_INVALID_CHARS_LETTER_NUM_SPACERS'		=> 'Полето “%s” съдържа невалидни знаци, само букви, цифри, празно място или -+_[] са позволени.',
	'FIELD_INVALID_CHARS_LETTER_NUM_UNDERSCORE'		=> 'Полето “%s” съдържа невалидни знаци, само букви, цифри или _ знаци са позволени.',
	'FIELD_INVALID_DATE'				=> 'Полето “%s” съдържа невалидна дата.',
	'FIELD_INVALID_URL'					=> 'Полето “%s” съдържа невалиден адрес.',
	...
	'FOLDER_MESSAGE_STATUS'		=> array(
		1	=> '%2$d от %1$s запаметени',
		2	=> '%2$d от %1$s запаметени',
	),
	...
	'FOLDER_STATUS_MSG'			=> array(
		1	=> 'Папката %3$d%% е пълна (%2$d от %1$s запаметени)',
		2	=> 'Папката %3$d%% е пълна (%2$d от %1$s запаметени)',
	),
	...
	'GRAVATAR_AVATAR_EMAIL'			=> 'Gravatar имейл',
	'GRAVATAR_AVATAR_EMAIL_EXPLAIN'	=> 'Въведете имейл адреса използван при регистрацията във <a href="http://www.gravatar.com/">Gravatar</a>.',
	'GRAVATAR_AVATAR_SIZE'			=> 'Размери на аватара',
	'GRAVATAR_AVATAR_SIZE_EXPLAIN'	=> 'Въведете ширина и височина на аватара, оставете празно, ако искате автоматично да се верифицира.',
	...
	'INVALID_EMOJIS_USERNAME'	=> 'Потребителското име съдържа забранени знаци (Emoji).',
	...
	'LOGIN_LINK'					=> 'Свържете или регистрирайте акаунта си на външна услуга със вашият акаунт във форума.',
	'LOGIN_LINK_EXPLAIN'			=> 'Тази външна услуга не е свързана с форума. Трябва да свържете този акаунт със съществуващ акаунт или да създадете нов.',
	'LOGIN_LINK_MISSING_DATA'		=> 'Нужната информация за външно свързване не е налична. Моля започнете процеса отново.',
	'LOGIN_LINK_NO_DATA_PROVIDED'	=> 'Нужната информация не е предоставена. Моля свържете се с администратора на форума, ако проблемите продължат.',
    'LOGIN_KEY'					=> 'Ключ за вход',
	'LOGIN_TIME'				=> 'Време на влизане',
	...
	'MOVE_PM_ERROR'					=> array(
		1	=> 'Грешка при преместването на съобщенията в новата папка, само %2$d от %1$s съобщения бяха преместени.',
		2	=> 'Грешка при преместването на съобщенията в новата папка, само %2$d от %1$s съобщения бяха преместени.',
	),
	...
	'NOTIFICATIONS_MARK_ALL_READ_CONFIRM'				=> 'Сигурен ли сте, че искате да маркирате всички съобщения като прочетени?',
	'NOTIFICATIONS_MARK_ALL_READ_SUCCESS'				=> 'Всички известия бяха маркирани като прочетени.',
	'NOTIFICATION_GROUP_MISCELLANEOUS'					=> 'Известия Други',
	'NOTIFICATION_GROUP_MODERATION'						=> 'Известия Модерация',
	'NOTIFICATION_GROUP_ADMINISTRATION'					=> 'Известия Администраторски',
	'NOTIFICATION_GROUP_POSTING'						=> 'Известия Мнения',
	'NOTIFICATION_METHOD_BOARD'							=> 'Известия',
	'NOTIFICATION_METHOD_EMAIL'							=> 'Имейл',
	'NOTIFICATION_METHOD_JABBER'						=> 'Jabber',
	'NOTIFICATION_TYPE'									=> 'Тип на известие',
	'NOTIFICATION_TYPE_BOOKMARK'						=> 'Някой отговаря на тема, която сте маркирали',
	'NOTIFICATION_TYPE_GROUP_REQUEST'					=> 'Някой иска да се включи в група, която вие водите',
	'NOTIFICATION_TYPE_IN_MODERATION_QUEUE'				=> 'Мнение или тема трябва да се одобри',
	'NOTIFICATION_TYPE_MODERATION_QUEUE'				=> 'Вашите теми/мнения са одобрени или отхвърлени от модератор',
	'NOTIFICATION_TYPE_PM'								=> 'Някой ви изпраща лично съобщение',
	'NOTIFICATION_TYPE_POST'							=> 'Някой отговаря в тема в която сте се абонирал',
	'NOTIFICATION_TYPE_QUOTE'							=> 'Някой ви цитира в мнение',
	'NOTIFICATION_TYPE_REPORT'							=> 'Някой докладва мнение',
	'NOTIFICATION_TYPE_TOPIC'							=> 'Някой създава тема във форум, в който сте абониран',
	'NOTIFICATION_TYPE_ADMIN_ACTIVATE_USER'				=> 'Потребител изисква активация',
	...
	'NOT_MOVED_MESSAGES'			=> array(
		1	=> 'Вие имате задържано %d лично съобщение, защото папката е пълна.',
	...
	'NO_AUTH_PROFILEINFO'			=> 'Вие не можете да променяте информацията в профила ви.',
	...
	'NO_AUTH_PRINT_MESSAGE'			=> 'Вие не можете да принтирате лични съобщения.',
	...
	'EMAIL_NOT_UNIQUE'			=> 'Имейл адреса, който въведохте вече се използва от друг потребител, трябва да изберете и потребителско име.',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Паролата трябва да е м/у %1$s и %2$s знака дълга и трябва да съдържа латински букви',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'Трябва да е м/у %1$s и %2$s знака.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Паролата трябва да е м/у %1$s и %2$s знака дълга и трябва да е миксирана',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'Паролата трябва да е м/у %1$s и %2$s знака дълга и трябва да съдържа символи',
	'PASSWORD'					=> 'Парола',
	'PASSWORD_ACTIVATED'		=> 'Новата парола беше активирана',
	'PASSWORD_UPDATED_IF_EXISTED'	=> 'Ако вашият акаунт съществува, нова парола беше изпратена на електронната Ви поща. Ако не получавате съобщението, това може да означава, че акаунта ви е блокиран или не съществува такъв. Също така, проверете в СПАМ папката на пощата ви.',
	...
	'PM_ICON'					=> 'ЛС икона',
	'PM_INBOX'					=> 'Входящи',
	'PM_MARK_ALL_READ'			=> 'Маркирай всички като прочетени',
	...
	'PM_SUBJECT'				=> 'Заглавие',
	'PM_TO'						=> 'Изпрати до',
	'PM_TOOLS'					=> 'Инструменти',
	'PM_USERS_REMOVED_NO_PERMISSION'	=> 'Някои от потребителите не могат да се добавят, защото нямат права за четене на лични съобщения.',
	'PM_USERS_REMOVED_NO_PM'	=> 'Някои от потребителите не могат да бъдат добавени, защото са изключили личните си съобщения.',
	...
	'PROFILE_AUTOLOGIN_KEYS'	=> '"Запомни ме" ключовете за достъп позволяват автоматично влизане на потребител. Ако излете от профила, ключа се изтрива само от устройството от което сте излезли. Тук можете да видите всички ключове за достъп.',
	'PROFILE_NO_AUTOLOGIN_KEYS'	=> 'Няма запазени ключове за достъп.',
	...
	'RULE_REMOVED_MESSAGES'				=> array(
		1	=> '%d лично съобщения беше изтрито заради добавеният филтър.',
		2	=> '%d лични съобщения бяха изтрити заради добавеният филтър.',
	),
	...
	'SELECT_CURRENT_TIME'		=> 'Изберете текущото време',
	'SELECT_TIMEZONE'			=> 'Изберете часова зона',
	'SORT'						=> 'Сортирай',
	...
	'UCP_AUTH_LINK_ASK'			=> 'За момента няма свързан акаунт с тази външна услуга. Натиснете бутона долу за да свържете акаунт с този форум.',
	'UCP_AUTH_LINK_ID'			=> 'Уникален идентификатор',
	'UCP_AUTH_LINK_LINK'		=> 'Свържи',
	'UCP_AUTH_LINK_MANAGE'		=> 'Управление на асоцирането на външни акаунти',
	'UCP_AUTH_LINK_NOT_SUPPORTED'	=> 'Свързването с външни акаунти в този форум не се поддържа.',
	'UCP_AUTH_LINK_TITLE'		=> 'Управление на асоцирането на външни акаунти',
	'UCP_AUTH_LINK_UNLINK'		=> 'Прекрати',
	...
	'UCP_JABBER'				=> 'Jabber',
	'UCP_LOGIN_LINK'			=> 'Настройка на външно асоциране на акаунт',
	...
	'UCP_NOTIFICATION_LIST'				=> 'Менажиране на известия',
	'UCP_NOTIFICATION_LIST_EXPLAIN'		=> 'Тук можете да видите всички минали известия.',
	'UCP_NOTIFICATION_OPTIONS'			=> 'Промяна на начин за известяване',
	'UCP_NOTIFICATION_OPTIONS_EXPLAIN'	=> 'Тук може да промените предпочитаният начин за известяване.',
	...
	'UCP_PROFILE_AUTOLOGIN_KEYS'=> 'Менажиране на “Запомни ме” ключовете за вход',
	...
	'UCP_PASSWORD_RESET_DISABLED'	=> 'Създаването на нова парола е изключено. Ако имате нужда от помощ, моля свържете се с %sBoard Administrator%s',
	...
	'USERNAME_ALPHA_ONLY_EXPLAIN'	=> 'Потребителското име трябва да е м/у %1$s и %2$s символа дълго и да използва само alphanumeric.',
	'USERNAME_ALPHA_SPACERS_EXPLAIN'=> 'Потребителското име трябва да е м/у %1$s и %2$s символа дълго и да използва alphanumeric, празно място или -+_[].',
	'USERNAME_ASCII_EXPLAIN'		=> 'Потребителското име трябва да е м/у %1$s и %2$s символа дълго и да използва само ASCII знаци, без специални символи.',
	'USERNAME_LETTER_NUM_EXPLAIN'	=> 'Потребителското име трябва да е м/у %1$s и %2$s символа дълго и да използва само букви и цифри.',
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'=> 'Потребителското име трябва да е м/у %1$s и %2$s знака дълго и да използва букви, цифри, празно място или +-[].',
	'USERNAME_CHARS_ANY_EXPLAIN'	=> 'Дължината трябва да е м/у %1$s и %2$s символа.',
